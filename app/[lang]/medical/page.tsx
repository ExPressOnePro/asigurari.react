                    ...
                    <div className="w-full max-w-3xl">
                        <div className="bg-white shadow-lg rounded-lg p-8">
                            ...
                            <p className="text-gray-600 text-center text-sm sm:text-base mb-8">
                                Медицинская страховка — это ваша финансовая защита в случае болезней и несчастных
                                случаев.
                                Она покрывает расходы на лечение, медикаменты и реабилитацию, обеспечивая вам и вашей
                                семье
                                душевное спокойствие. Выберите подходящий полис и будьте готовы к любым непредвиденным
                                ситуациям.
                            </p>
                            <div className="flex justify-center">
                                <button
                                    className="bg-gray-400 cursor-not-allowed text-white font-semibold py-2 px-4 rounded-lg shadow-md"
                                >
                                    Скоро...
                                </button>
                            </div>
